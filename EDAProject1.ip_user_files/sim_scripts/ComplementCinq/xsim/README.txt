...
#
# Generated by export_simulation on Thu Nov 30 01:47:55 +0800 2017
#
################################################################################
...
switch to the './ComplementCinq.sh' script.

./ComplementCinq.sh -reset_run
...
./ComplementCinq.sh -noclean_files

For more information on the script, please type './ComplementCinq.sh -help'.
